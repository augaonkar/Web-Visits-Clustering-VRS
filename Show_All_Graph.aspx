<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Show_All_Graph.aspx.cs" Inherits="Show_All_Graph" %>
...
<ul>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Show All Graphs&nbsp;
        ...
        <td class="style8">
            &nbsp;</td>
        <td>
        <asp:Panel ID="Panel1" runat="server" Height="1722px">
                                <table>
                                    <tr>
                                        <td class="style7">
                                            &nbsp;</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gv_data" runat="server" AllowPaging="True" 
                                                            onpageindexchanging="gv_data_PageIndexChanging" Width="326px">
                                                            <Columns>
         ...
         PieDrawingStyle=Concave, MaxPixelPointWidth=50" IsValueShownAsLabel="True" Name="Series1" ShadowOffset="2">
                                                                    ...
                                                                    <ChartAreas>
                                                                        <asp:ChartArea BackGradientStyle="TopBottom" Name="ChartArea1">
                                                                            <AxisX Title="Date" TitleForeColor="Brown">
                                                                            </AxisX>
                                                                            <AxisY Title="No of Visitors" TitleForeColor="Brown">
                                                                            </AxisY>
                                                                        </asp:ChartArea>
                                                                ...
                                                                <asp:Chart ID="Chart4" runat="server" Height="400px" Width="500px">
                                                                    ...
                                                                    <ChartAreas>
                                                                        <asp:ChartArea BackColor="Transparent" BackSecondaryColor="Transparent" 
                                                                            ...
                                                                            <axisy LineColor="64, 64, 64, 64" Title="City">
