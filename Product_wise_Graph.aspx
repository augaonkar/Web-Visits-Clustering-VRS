<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_wise_Graph.aspx.cs" Inherits="Product_wise_Graph" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Graphical Reports</span></a>
      <ul>
         ...
         <li class="active"><a href="Product_wise_Graph.aspx"><span>Productwise Reports</span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System- Productwise Graph&nbsp;
        ...
        <td>
        <asp:Panel ID="Panel1" runat="server" Height="1392px">
                                <table>
                                    <tr>
                                        <td class="style7">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="style1" colspan="4">
                                            Select Chart -&nbsp;&nbsp;&nbsp;
                                            <asp:DropDownList ID="ddl_chart" runat="server" Height="27px" Width="136px">
