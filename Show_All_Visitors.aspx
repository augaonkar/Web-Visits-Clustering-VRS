<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Show_All_Visitors.aspx.cs" Inherits="Show_All_Visitors" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Tabular Visitor Reports </span></a>
      <ul>
         <li class="active"><a href='Show_All_Visitors.aspx'><span>Show All Visitors</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Show All Visitors&nbsp;
                            ...
                            <td>
                              ...
                              <asp:GridView ID="Grid_Log" runat="server" CellPadding="4" ForeColor="#333333" 
                                    GridLines="Both" Width="917px" AllowPaging="True" 
