<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Total_Visitors_Report.aspx.cs" Inherits="Total_Visitors_Report" %>
...
<ul>
   ...
   <li class="active"><a href='Total_Visitors_Report.aspx'><span>Total Visitor Details </span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Total Visitors Report&nbsp;
        ...
        <table>
                                    ...
                                    <tr>
                                        <td align="center" class="style1" colspan="3">
                                            <asp:Label ID="Label15" runat="server" Font-Bold="False" Font-Size="Medium" 
                                                Text="Product Visitors"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" class="style1" colspan="3">
                                    ...
                                    <tr>
                                        <td class="style1" colspan="3">
                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" 
                                                HeaderStyle-HorizontalAlign="Center" ForeColor="#333333" GridLines="Both">
