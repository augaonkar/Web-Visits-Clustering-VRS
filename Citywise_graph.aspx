<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Citywise_graph.aspx.cs" Inherits="Citywise_graph" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Graphical Reports</span></a>
      <ul>
         ...
         <li class="active"><a href="Citywise_graph.aspx"><span>Citywise Reports</span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Citywise Graphs&nbsp;
        ...
        <td>
        <asp:Panel ID="Panel1" runat="server" Height="1970px">
                                <table>
                                    <tr>
                                        <td class="style7">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="style1" colspan="4">
                                            &nbsp;&nbsp;&nbsp; Select City -
                                            <asp:DropDownList ID="ddl_city" runat="server" Height="27px" Width="163px">
                                            </asp:DropDownList>
                                        </td>
                                        <td colspan="3">
                                            &nbsp;</td>
