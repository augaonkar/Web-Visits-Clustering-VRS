...
<ul>
   ...
   <li class="active"><a href='Comparison.aspx'><span>Comparison</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Comparison&nbsp;
        ...
        <table class="style2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;</td>
                                        <td>
                                            <asp:Label ID="Label38" runat="server" Text="Enter No of Clusters : "></asp:Label>
                                            <asp:TextBox ID="txt_no_clu" runat="server" Font-Bold="True" Width="53px"></asp:TextBox>
                                        &nbsp;&nbsp;
                                        ...
                                        <td>
                                            <asp:Button ID="btn_start" runat="server" onclick="btn_start_Click" 
                                                Text="Start Proccess" Width="120px" Height="27px" />
                                        </td>
                                    </tr>
               <%-- <tr>
                    <td>
                                    <asp:Label ID="Label1" runat="server" 
                                        Text="                               No. of Clusters : - "></asp:Label>
                                </td>
                    <td>
                                    <asp:TextBox ID="txt_no_clu" runat="server" Width="53px" 
                    ...
                    <td>
                            ...
                            Text="Start" Width="79px" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;</td>
                                        <td colspan="4">
                                            <asp:GridView ID="gv_city" runat="server" CellPadding="4" ForeColor="#333333" 
                                                GridLines="Both">
                        ...
                        <%#Container.DataItemIndex+1 %>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:GridView ID="GV_data1" runat="server" CellPadding="4" ForeColor="#333333" 
                                                GridLines="both" Width="74px">
                                                <RowStyle BackColor="#EFF3FB" />
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Sr.No" 
