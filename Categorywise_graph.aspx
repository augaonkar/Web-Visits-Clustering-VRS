<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Categorywise_graph.aspx.cs" Inherits="Categorywise_graph" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Graphical Reports</span></a>
      <ul>
         ...
         <li class="active"><a href="Categorywise_graph.aspx"><span>Categorywise Reports</span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System- Categorywise Reports&nbsp;
        ...
        <td>
        <asp:Panel ID="Panel1" runat="server" Height="2182px">
                                <table>
                                    <tr>
                                        <td class="style7">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="style1" colspan="5">
                                            Select Category -
                                            <asp:DropDownList ID="ddl_category" runat="server" Height="27px" Width="137px">
                                    ...
                                    <tr>
                                        <td class="style1" colspan="5">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Select Chart -
                                            <asp:DropDownList ID="ddl_chart" runat="server" Height="27px" Width="137px">
                                            ...
                                            &nbsp;<asp:Button ID="btn_get" runat="server" Height="27px" 
                                                onclick="btn_get_Click" Text="Get Report" Width="76px" />
                                        </td>
                                        <td colspan="3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gv_data" runat="server" AllowPaging="True" 
                                                            onpageindexchanging="gv_data_PageIndexChanging" Width="251px">
                                                            <Columns>
                                                    ...
                                                    <td>
                                                        <asp:MultiView ID="MultiView1" runat="server">
                                                                ...
                                                                <asp:Chart ID="Chart1" runat="server">
                                                                    ...
                                                                    <ChartAreas>
                                                                        <asp:ChartArea Name="ChartArea1">
                                                                            <AxisX Interval="Auto" Title="City" TitleForeColor="Brown">
                                                                            </AxisX>
                                                            ...
                                                            <asp:View ID="View5" runat="server">
                                                                <asp:Chart ID="Chart5" runat="server" BackGradientStyle="TopBottom" 
                                                                    Height="300px" Width="500px">
                                                                    <Legends>
                                                                        <asp:Legend Alignment="Center" BackColor="Transparent" Docking="Left" 
                                                                            Font="Trebuchet MS, 8.25pt, style=Bold" IsTextAutoFit="true" 
                                                                    ...
                                                                    <Series>
                                                                        <asp:Series ChartType="Doughnut" IsValueShownAsLabel="True">
                                                                        </asp:Series>
                                                                    </Series>
                                                                    <ChartAreas>
                                                                        <asp:ChartArea BackGradientStyle="TopBottom" Name="ChartArea1">
