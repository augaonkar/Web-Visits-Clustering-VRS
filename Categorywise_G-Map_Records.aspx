<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Categorywise_G-Map_Records.aspx.cs" Inherits="Categorywise_G_Map_Records" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Visitor Reports On G-map</span></a>
      <ul>
         <li class="active"><a href='Categorywise_G-Map_Records.aspx'><span>Categoerywise G-map Reports</span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Categorywise G-Map Records&nbsp;
        ...
        <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="style2">
                                            <asp:DropDownList ID="ddl_cat" runat="server" Height="28px">
                                                <asp:ListItem>Sony</asp:ListItem>
                                                <asp:ListItem>Canon</asp:ListItem>
                                                <asp:ListItem>NIkon</asp:ListItem>
                                            </asp:DropDownList>
                                        &nbsp;<asp:Button ID="btn_get" runat="server" Text="Get Data" Width="108px" 
                                                onclick="btn_get_Click" Height="26px" />
                                        </td>
 ...
 <script type="text/javascript">
    ...
    <div id="Mapdiv" style="width: 650px; height: 500px">
    </div>    
