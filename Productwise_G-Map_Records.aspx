<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Productwise_G-Map_Records.aspx.cs" Inherits="Productwise_G_Map_Records" %>
...
<ul>
   ...
   <li class='has-sub'><a><span>Visitor Reports On G-map</span></a>
      <ul>
         ...
         <li  class="active"><a href='Productwise_G-Map_Records.aspx'><span>Productwise G-map Reports</span></a></li>
   ...
   <li><a href='SignOut.aspx'><span>Sign Out</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Productwise G-Map Records&nbsp;
        ...
        <table align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style2">
                                            <asp:Button ID="btn_getdata" runat="server" Text="Get Data" Width="94px" 
                                                onclick="btn_getdata_Click" Height="26px" />
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
    ...
    <div id="Mapdiv" style="width: 650px; height: 500px; text-align: left;">
    </div>    
