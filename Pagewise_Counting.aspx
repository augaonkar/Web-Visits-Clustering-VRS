<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pagewise_Counting.aspx.cs" Inherits="Pagewise_Counting" %>
...
<ul>
   ...
   <li class="active"><a href='Pagewise_Counting.aspx'><span>Pagewise counting</span></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Variance Rover System :- Pagewise Counting&nbsp;
                                    ...
                                    <tr>
                                        <td class="style11" colspan="7">
                                            <asp:GridView ID="Grid_Log" runat="server" CellPadding="4" ForeColor="#333333" 
                                                GridLines="Both" Width="400px" AllowPaging="True" PageSize="15" 
